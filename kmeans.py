...
class PoseClustering:
    ...
    def cluster_poses(self):
        ...
        return np.array(core_poses), X, labels, centers, poses, frame_ids
...
# 假设我们有一个JSON文件
json_file_path = '/home/haoge/solopose/SoloShuttlePose/res 20160430-1/players/player_kp/20160430-1.json'
