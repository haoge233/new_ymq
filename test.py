...
#     top_data = coordinates.get("top", None)
#     bottom_data = coordinates.get("bottom", None)

#     # 检查是否有数据，若没有数据则认为该帧为空
#     if top_data is None or bottom_data is None:
...
# # 选定三帧的 Frame IDs
# frame_ids = [ '10222', '9136','10220','11976']  # 替换为实际的 Frame ID
...
#                 bottom_keypoints[4]=(bottom_keypoints[5]+bottom_keypoints[6])*1/2
#                 print(bottom_keypoints)
#                 if bottom_keypoints.size > 1:
#                     keypoints_list.append(bottom_keypoints)
#                 else:
...
#     7: '4-5-7',
#     9: '4-5-7-9',
#     12: '4-6-12',  # 注意：这里虽然表2中有重复，但只计算一次
#     8: '4-6-8',
#     10: '4-6-10',  # 假设有一个从6到10的路径段增量，尽管表2中没有直接给出
#     13: '4-5-11-13',
#     14: '4-6-12-14',
#     15: '4-5-11-13-15',  # 假设有一个从13到15的路径段增量
#     16: '4-6-12-14-16',  # 假设有一个从14到16的路径段增量
# },  transforms)
